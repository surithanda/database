...
BEGIN
    ...
    DECLARE favorite_profile_id_val INT;
    ...
    BEGIN
        ...
        INSERT INTO activity_log (
            ...
            'ERROR', error_message, p_created_user, 'PROFILE_FAVORITES_DELETE', 
    ...
    SELECT COUNT(*), profile_id, favorite_profile_id INTO record_exists, profile_id_val, favorite_profile_id_val
    ...
    INSERT INTO activity_log (
        ...
        CONCAT('ID: ', p_id, ', Profile ID: ', profile_id_val, ', Favorite Profile ID: ', favorite_profile_id_val),
        start_time, end_time, execution_time
    );
