DELIMITER //
CREATE PROCEDURE `eb_profile_contacted_delete`(
    IN p_id INT,
...
BEGIN
    ...
    DECLARE contacted_profile_id_val INT;
    ...
    BEGIN
        ...
        INSERT INTO activity_log (
            ...
            'ERROR', error_message, p_created_user, 'PROFILE_CONTACTED_DELETE', 
    ...
    IF p_id IS NULL OR p_id <= 0 THEN
        SET error_code = '60015';
        SET error_message = 'Invalid id. It must be a positive integer.';
        SIGNAL SQLSTATE '45000' 
        SET MESSAGE_TEXT = error_message;
    END IF;
    
    -- Check if the contact record exists and get the profile_id and contacted_profile_id
    SELECT COUNT(*), profile_id, contacted_profile_id INTO record_exists, profile_id_val, contacted_profile_id_val
    FROM profile_contacted 
    WHERE id = p_id;
    
    IF record_exists = 0 THEN
        SET error_code = '60016';
    ...
    INSERT INTO activity_log (
        ...
        'DELETE', 
        CONCAT('Contact record deleted with ID: ', p_id), 
        p_created_user, 
        'PROFILE_CONTACTED_DELETE', 
        CONCAT('ID: ', p_id, ', Profile ID: ', profile_id_val, ', Contacted Profile ID: ', contacted_profile_id_val),
        start_time, end_time, execution_time
    );
