DELIMITER //
CREATE PROCEDURE `eb_profile_views_delete`(
    IN p_id INT,
...
BEGIN
    ...
    DECLARE viewed_profile_id_val INT;
    ...
    BEGIN
        ...
        INSERT INTO activity_log (
            ...
            'ERROR', error_message, p_created_user, 'PROFILE_VIEWS_DELETE', 
    ...
    IF p_id IS NULL OR p_id <= 0 THEN
        SET error_code = '59013';
        SET error_message = 'Invalid id. It must be a positive integer.';
        SIGNAL SQLSTATE '45000' 
        SET MESSAGE_TEXT = error_message;
    END IF;
    
    -- Check if the view record exists and get the profile_id and viewed_profile_id
    SELECT COUNT(*), profile_id, viewed_profile_id INTO record_exists, profile_id_val, viewed_profile_id_val
    FROM profile_views 
    WHERE id = p_id;
    
    IF record_exists = 0 THEN
        SET error_code = '59014';
    ...
    INSERT INTO activity_log (
        ...
        'DELETE', 
        CONCAT('View record deleted with ID: ', p_id), 
        p_created_user, 
        'PROFILE_VIEWS_DELETE', 
        CONCAT('ID: ', p_id, ', Profile ID: ', profile_id_val, ', Viewed Profile ID: ', viewed_profile_id_val),
        start_time, end_time, execution_time
    );
