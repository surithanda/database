DELIMITER //
CREATE PROCEDURE `eb_profile_education_delete`(
...
BEGIN
    ...
    BEGIN
        ...
        INSERT INTO activity_log (
            ...
            'ERROR', error_message, p_created_user, 'PROFILE_EDUCATION_DELETE', 
    ...
    INSERT INTO activity_log (
        ...
        'DELETE', 
        CONCAT('Education record deleted with ID: ', p_profile_education_id), 
        p_created_user, 
